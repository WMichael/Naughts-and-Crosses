    ...
    if (turnBeingTaken == false) {
      ...
      for (i = 0; i < 3; i++) {
        if (Gameboard.board[i][0] == "x" && Gameboard.board[i][1] == "x" && Gameboard.board[i][2] == "x") {
          win = true;
          Gameboard.greenTiles(i, 0, i, 1, i, 2);
          ...
          win = true;
          Gameboard.greenTiles(0, i, 1, i, 2, i);
      ...
      if (Gameboard.board[0][0] == "o" && Gameboard.board[1][1] == "o" && Gameboard.board[2][2] == "o") {
        win = true;
        Gameboard.greenTiles(0, 0, 1, 1, 2, 2);
        ...
        win = true;
        Gameboard.greenTiles(0, 2, 1, 1, 2, 0);
